...
//                   ServiceWorkerRegistration[j][1] = socketRoomnum[j][1] +1 ;
//                   hasroomnum = true;
//                 }
//               }
//               if (hasroomnum == false){
...
//             });
//             return chat.in(room).emit("joinned", room);
//           }
//         });
...
//               socket.leave(room);
//               chat.to(room).emit("notice", "A uesr has left");
//             }
//           }
...
//             }
//           }
//           xonnsole.log("Client disconnected");
//         });
//     });
//   }
// }
